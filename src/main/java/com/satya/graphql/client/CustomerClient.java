package com.satya.graphql.client;

import com.satya.graphql.dto.Customer;
import com.satya.graphql.dto.CustomerInput;
import com.satya.graphql.dto.WatchListInput;
...
public class CustomerClient {
  ...
  public Mono<Customer> getCustomer(Integer id) {
    return this.client.get().uri("{id}", id).retrieve().bodyToMono(Customer.class);
  }
